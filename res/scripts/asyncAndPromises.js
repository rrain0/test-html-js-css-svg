...
function testAsyncAndPromises(){
	...
	*/
	...
	// Запланировать асинхронное выполнение функции через 3000 мс.
	...
	// асинхронные результаты естетсвенно тоже не могут исполниться, т.к. очередь обрабатывает эту функцию
